...
model = load_model('C:/Users/harish/Desktop/XPressiify/backend/models/emotion_recognition_model.h5')
#model.evaluate()
# Emotion class names
class_names = ['angry', 'happy', 'fear', 'disgust', 'neutral', 'sad', 'surprise']
